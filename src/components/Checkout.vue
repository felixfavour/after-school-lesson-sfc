    ...
    <section class="main-catalog page">
      <div class="catalog-body">
        ...
        <div class="lessons-catalog">
          <div v-for="(lesson, index) in cart" :key="lesson._id" class="lesson-card">
            ...
            <div class="lesson-info">
              ...
              <div class="lesson-info-bottom">
                ...
                <button class="primary-btn remove-btn" v-on:click="$emit('removeLesson', index)">
...
export default {
  ...
  computed: {
    uniqueLessonsInCart () {
      ...
      cartCopy.forEach((lesson) => lessons.add(lesson._id))

  ...
  <div class="home-page">
    ...
    <section class="main-catalog">
      ...
      <div class="catalog-body page">
        ...
        <div v-else class="lessons-catalog">
          <div v-for="lesson in lessonsCopy" :key="lesson._id" class="lesson-card">
            <img v-bind:src="require(`@/assets/${lesson.image}`)" alt="">
            <div class="lesson-info">
              ...
              <div class="lesson-info-bottom">
                <div class="stars">
                  <svg v-for="star in lesson.stars" :key="star" class="star-filled" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg v-for="star in 5-lesson.stars" :key="star+10" class="star-outlined" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button v-if="canAddToCart(lesson)" v-on:click="$emit('addLesson', lesson)" class="primary-btn">
                  <span>Add to Cart</span> <span>+</span>
                </button>
                <button v-else disabled="true" class="primary-btn">
                  <span>Add to Cart</span> <span>+</span>
                </button>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    sortDirection: function (dir) {
      ...
      this.lessonsCopy = this.lessonsCopy.reverse()
    },
    sortLessons: function (type) {
      ...
      switch (type) {
        case 'nothing': 
        this.lessonsCopy = [...this.lessons].reverse()
          break
        case 'topic': 
          ...
          this.lessonsCopy = [...this.lessons].sort(compare)
          break
        case 'location': 
          compare = function (a, b) {
    ...
    searchLessons: function (query) {
      this.lessonsCopy.slice(0)
      const app = this
      if (query === '') {
        this.lessonsCopy = this.lessons
      } else {
